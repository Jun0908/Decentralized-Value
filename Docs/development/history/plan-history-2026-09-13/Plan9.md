...
Docs/product/arenas/rescue-room.md
...
- [x] Phase 1実装時に`Docs/product/arenas/rescue-room.md`を追加する
...
- [x] 検証済みPublic Journeyだけを`Docs/hackathon/DEMO.md`へ追加する
- [ ] Public Deploy後にだけroot `README.md`を更新する
- [ ] 完了または中止後にこのPlanを`Docs/development/plans/`へ移す
...
2026-09-12（日本時間）。§29の競技・UX Gateを通過済みとはせず、ユーザー承認に基づき、実AI実行と実決済の接続検証を独立したPilotとして先行した。[公開Evidence JSON](../../../evidence/deployments/sepolia-rescue-service-demo.json)と[実行バッチ](../../guides/RESCUE_EXECUTION_BATCH.md)を参照。
...
2026-09-12。§31の支払い済み成果物を再利用し、追加送金なしでCommanderへ返す短い実証を追加した。[提出手順と動画台本](../../../hackathon/submission/HACKATHON_SUBMISSION.md)を正本とする。
...
2026-09-12。計画後の実行指示により着手。横断優先順は[NEXT_UNATTENDED_BATCH.md](NEXT_UNATTENDED_BATCH.md)、成果物は[RESCUE_HANDOFF.md](../../../hackathon/submission/RESCUE_HANDOFF.md)。
...
2026-09-12。比較設計は[RESCUE_INFORMATION_STUDY.md](../../plans/rescue-information-study.md)。
