...
- Production AI configuration and duration remain tracked in [production readiness](../../evidence/verification/PRODUCTION_READINESS_2026-09-13.md); this cleanup does not resolve those deployment tasks.
