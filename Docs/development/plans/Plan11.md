...
This is the consolidated current plan. The [original specification and execution history](../history/plan-history-2026-09-13/Plan11.md) remains unchanged. Game design belongs to [Plan 9](Plan9.md) and [Plan 10](Plan10.md); public API/tooling belongs to [Plan 12](Plan12.md).
...
Discovery reached an allowed HTTPS Rescue API and verified its response. See [evidence](../../evidence/deployments/ensv2-rescue-demo.json), [adapter](../../../packages/ens-adapter/src/rescue.ts), and [execution script](../../../scripts/demo-ens-rescue.ts). The read-only recheck is `pnpm exec tsx scripts/verify-ens-rescue.ts`.
...
Sources: [live connection record](../../hackathon/sponsors/BAZANTIC_RESCUE_LIVE.md), [agent evidence](../../evidence/deployments/bazantic-rescue-agent-demo.json), [implementation](../../../apps/api/src/bazantic-rescue-agent.ts).
...
Sources: [evidence](../../evidence/deployments/chainlink-cre-private-pack.json), [workflow](../../../workflows/chainlink-cre/rescue-envelope/secret-pack/main.ts), [runbook](../../hackathon/sponsors/chainlink-cre.md).
...
Immediate release-readiness work is tracked in [PRODUCTION_READINESS_2026-09-13.md](../../evidence/verification/PRODUCTION_READINESS_2026-09-13.md): generated CRE bundles currently lack an ESLint ignore, public AI readiness is separate from saved sponsor evidence, and API payment metadata needs an evidence-backed update.
