...
Source: [reference-match generator](../../../scripts/ocean-reference-match.ts), [transaction script](../../../scripts/settle-ocean-match.sh), and [original record, section 74](../history/plan-history-2026-09-13/Plan10.md). This documentation edit did not send or independently recheck chain transactions.
...
The latest original Phase 0 record reports 42 passing tests; later entry and integrated-project test records are separate. Current public-page verification is recorded in [PUBLIC_VERIFICATION_2026-09-13.md](../../evidence/verification/PUBLIC_VERIFICATION_2026-09-13.md). This edition changes documentation, not game rules or experimental results.
