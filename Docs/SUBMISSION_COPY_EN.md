...
Public verification and its exact boundaries: [September 13 check](PUBLIC_VERIFICATION_2026-09-13.md). Newly added local onboarding changes must not be described as deployed until their own deployment is verified.
