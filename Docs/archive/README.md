...
Archived files may contain stale paths, incomplete checkboxes, superseded sponsor priorities, or claims that conflict with the current implementation. Use `Docs/STATUS.md`, `Docs/PRODUCT.md`, and `Docs/ARCHITECTURE.md` as the current sources of truth. Start new work from the current documents rather than extending an archived plan.
