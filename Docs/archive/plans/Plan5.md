...
> Historical plan. The Classic Emergency Supply implementation remains available, but current product requirements live in `Docs/STATUS.md` and `Docs/arenas/emergency-supply.md`.
