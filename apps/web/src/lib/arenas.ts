...
export const arenaRegistry = [
  ...
  },
  {
    ...
    status: "Practice",
    funding: { state: "none" },
    headline: "Power a community through a changing day.",
    summary:
    ...
    evidenceLevel: 0,
    evidenceLabel: "Deterministic modeled day · separate classic mix",
    metrics: [
      { name: "Energy cost", direction: "Minimize", unit: "USD" },
      { name: "Unserved energy", direction: "Minimize", unit: "MWh" },
      { name: "Operational carbon", direction: "Minimize", unit: "kgCO₂" },
    ],
    participation: "Open practice",
    deadline: "No deadline",
    reward: "No practice reward",
